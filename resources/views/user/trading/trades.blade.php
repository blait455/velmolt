                ...
                <div class="card-header checkx">
                  <div class="row align-items-center">
                    ...
                    <div class="col-6 text-right">
                      @if($val->claim==1)
                        @if($val->status!=2)
                          <a href="#" data-toggle="modal" data-target="#history{{$val->id}}" class="btn btn-sm btn-neutral">{{__('History')}}</a>
                          <a href="#" data-toggle="modal" data-target="#claim{{$val->id}}" class="btn btn-sm btn-neutral">{{__('Claim Profit')}}</a>
                        @endif
                      @endif
                    </div>
                  </div>

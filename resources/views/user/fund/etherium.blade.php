    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card" style="background-color:{{$set->d_c}};">
              <div class="card-body text-center">
                <div class="">
                  <div>
                    <h3 class="card-title mb-3 text-dark">{{__('Etherium transfer details')}}</h3>
                    <ul class="list list-unstyled mb-0 card-text text-sm text-dark">
                      <li>{{__('Vendor')}}: {{$bank->eth_vendor}}</li>
                      <li>{{__('Wallet ID')}}: {{$bank->eth_id}}</li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-8">
            ...
            <div class="card-header">
                <h3 class="mb-0 text-dark">{{__('Manual Crypto Transfer')}}</h3>
            </div>
            <div class="card-body">
